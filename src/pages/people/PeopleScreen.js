...
const PeopleScreen = ({ navigation }) => {
    ...
    const getListaPeople = (url) => {
        const apiUrl = url || "https://swapi.dev/api/people/";
        axios
            .get(apiUrl)
            .then((response) => {
    ...
    const handleNextPage = () => {
        if (nextPage) {
            getListaPeople(nextPage);
        }
    };

    const handlePreviousPage = () => {
        if (previousPage) {
            getListaPeople(previousPage);
        }
    };
    ...
    const postPeopleClick = (item) => {
        console.log(item);
        navigation.navigate("persondetail", item);
    };
    return (
        <View style={styles.container}>
            ...
            <View style={styles.data}>
                ...
                <View style={styles.text}>
                    <Text style={styles.subtitle}>List of people</Text>
                </View>
            </View>
            <FlatList
                data={filteredPeople}
