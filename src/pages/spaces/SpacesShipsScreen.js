...
const SpacesShipsScreen = ({ navigation }) => {
    ...
    const handleNextPage = () => {
        if (nextPage) {
            getSpaceships(nextPage);
        }
    };

    const handlePreviousPage = () => {
        if (previousPage) {
            getSpaceships(previousPage);
        }
    };

    const handleSearch = (text) => {
        setSearchQuery(text);
        const filteredData = spaceships.filter((spaceship) =>
            spaceship.name.toLowerCase().includes(text.toLowerCase())
        );
        setFilteredSpaceships(filteredData);
    };

    const navigateToDetail = (item) => {
        console.log(item);
        navigation.navigate("spaceShipdetail", item);
    };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.data}>
                ...
                <View style={styles.text}>
                    <Text style={styles.subtitle}>List of starships</Text>
                </View>
            </View>
            <FlatList
...
export default SpacesShipsScreen;
