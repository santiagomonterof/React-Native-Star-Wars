...
const SpeciesScreen = ({ navigation }) => {
    ...
    const getSpecies = (url) => {
        const apiUrl = url || "https://swapi.dev/api/species/";
        axios
            .get(apiUrl)
            .then((response) => {
                setSpecies(response.data.results);
                setFilteredSpecies(response.data.results);
    ...
    const handlePreviousPage = () => {
        if (previousPage) {
            getSpecies(previousPage);
        }
    };

    const handleSearch = (text) => {
        setSearchQuery(text);
        const filteredData = species.filter((specie) =>
            specie.name.toLowerCase().includes(text.toLowerCase())
        );
        ...
        <View style={styles.container}>
            ...
            <View style={styles.data}>
                ...
                <View style={styles.text}>
                    <Text style={styles.subtitle}>List of species</Text>
                </View>
            </View>
            <FlatList
